...
use valence_domain_clients::{
    evm::{
        ...
        bundle::{
            FlashbotsBundle, 
            PrivacyHint, create_eth_bundle, create_mev_share_bundle,
        },
    },
    EvmBaseClient,
};
...
async fn main() -> Result<(), Box<dyn Error>> {
    ...
    let flashbots_auth_key = env::var("FLASHBOTS_AUTH_KEY")
        .unwrap_or_else(|_| {
    ...
    let eth_client = EthereumClient::new(&rpc_url, "", None)?
        .with_flashbots_auth(auth_bytes);
    ...
    println!("Current block: {}, targeting block: {}", current_block, target_block);
    ...
    let placeholder_tx = "0x02f86c0180843b9aca00825208945555763613a12d8f3e73be831dff8598089d4fde8702ce7de1537c008025a0bfe7d7e3e56fc3513640105b5c0ce4d50c47e6ec40b5876459105744a5238f07a05ec5fd4b2e1c0f15164604ac370929c397e8ea82a11527be39583135093162c3";
    ...
    let basic_bundle = create_eth_bundle(
        vec![placeholder_tx.to_string()], 
        target_block, 
        None
    );
    ...
    match eth_client.simulate_bundle(basic_bundle.clone()).await {
        Ok(simulation_results) => {
            ...
            println!("Coinbase payment: {:?}", simulation_results.get("coinbaseDiff"));
    ...
    println!("MEV-Share bundle created for blocks: {} to {}", target_block, target_block + 3);
