...
pub(crate) fn convert_proto_events<E>(
    proto_events: Vec<E>,
) -> Vec<Event> 
where
...
mod tests {
    use super::*;
    use cosmos_sdk_proto::tendermint::abci::{Event as ProtoEvent, EventAttribute as ProtoEventAttribute};
    use serde_json;
    ...
    fn test_transaction_response_new() {
        ...
        let block_hash = Some("0xabcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890".to_string());
        ...
        assert_eq!(tx_response.original_request_payload, original_request_payload);
    }
}
