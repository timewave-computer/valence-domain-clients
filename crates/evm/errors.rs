...
mod tests {
    ...
    fn test_error_creation() {
        ...
        let connection_err = EvmError::ConnectionError("failed to connect".to_string());
        let serialization_err = EvmError::SerializationError("invalid format".to_string());
        ...
        let balance_err = EvmError::InsufficientBalance("not enough ETH".to_string());
        ...
        let not_impl_err = EvmError::NotImplemented("feature not available".to_string());
    ...
    fn test_error_messages() {
        ...
        assert_eq!(
            ...
            "Contract error: invalid contract"
        );
