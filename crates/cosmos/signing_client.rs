...
use crate::{
    ...
    cosmos::types::{CosmosFee, CosmosBroadcastMode, CosmosBroadcastTxRequest},
};
...
fn to_cosmrs_fee(
    ...
    let amount: Vec<CosmrsCoin> = fee
        ...
        .map(|coin| {
            Ok(CosmrsCoin {
                denom: coin.denom.parse::<CosmrsDenom>()?,
                amount: coin.amount,
            })
        })
...
impl SigningClient {
    ...
    pub(crate) async fn create_tx(
        ...
        Ok(CosmosBroadcastTxRequest {
            ...
            mode: broadcast_mode,
            fee_setting: crate::cosmos::types::FeeSetting::default(),
            memo: None,
        })
    }
}
