...
impl BabylonClient {
    ...
    pub async fn query_btc_tap_balance(&self, address: &str) -> Result<u128, ClientError> {
    ...
    pub async fn query_pos_tap_balance(&self, address: &str) -> Result<u128, ClientError> {
