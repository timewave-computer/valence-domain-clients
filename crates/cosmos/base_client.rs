//-----------------------------------------------------------------------------
// Cosmos Base Client Definition
//-----------------------------------------------------------------------------

//! Base trait definition for Cosmos ecosystem clients.
//!
//! This module defines the `CosmosBaseClient` trait that provides a standardized
//! interface for interacting with Cosmos SDK-based blockchains.
...
use crate::cosmos::types::{
    CosmosCoin, CosmosHeader, CosmosBlockResults, CosmosModuleAccount,
};
